        ...
        <section className="w-full bg-[#f7f500] overflow-hidden flex items-center px-8 py-16">
            <div className="md:flex gap-10">
                ...
                <div className="w-2/5 font-helvetica md:flex flex-col justify-between">
                    ...
                    <div className="w-32 border-2 border-solid border-black text-center rounded-3xl hover:border-black text-[#f7f500] hover:text-black bg-black hover:bg-[#f7f500]">
